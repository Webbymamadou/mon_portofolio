...
const PROJECTS = [
  ...
  {
    title: 'GestStock',
    subtitle: 'Application de gestion de stock & facturation',
    bg: '/images/work-5.jpg',
    tech: 'Laravel, PostgreSQL, Bootstrap',
    features: 'Entrées/Sorties, Facturation PDF, Alertes de seuil',
    link: 'https://github.com/Webbymamadou/GestStock',
    linkType: 'github',
    linkText: 'Code Source sur GitHub',
  },
  {
    title: 'WebPilot',
    subtitle: 'Générateur de sites vitrines automatisé',
    bg: '/images/work-2.jpg',
    tech: 'Django, React, Celery, PostgreSQL',
    features: 'Génération dynamique, Templates, CMS léger',
    link: 'https://github.com/Webbymamadou/WebPilot',
    linkType: 'github',
    linkText: 'Code Source sur GitHub',
  }
];
